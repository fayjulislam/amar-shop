...
const displayRatingIcon = (rate) => {
  ...
  for (let i = 0; i < floorRate; i++) {
    ratingIcon += `<i class="bi bi-star-fill"></i>`;
  }
  ratingIcon += `<i class="bi bi-star-half"></i>`;

  if (5 - floorRate > 1) {
    for (let i = 0; i < 5 - floorRate - 1; i++) {
      ratingIcon += `<i class="bi bi-star"></i>`;
    }
  }
    ...
    div.innerHTML = `
            <div class="card h-100">
                ...
                <span class = "fs-6 rating">Rating: </span>
                    <span class = "text-warning fs-6 fw-bold">${displayRatingIcon(product.rating.rate)} <span class = "text-secondary fw-bold">(${product.rating.rate})</span></span>
                </div>
                </div>
...
// Function of Update product price
